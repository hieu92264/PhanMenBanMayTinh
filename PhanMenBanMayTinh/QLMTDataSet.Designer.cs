...
namespace PhanMenBanMayTinh {
    ...
    public partial class QLMTDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow AddAccountsRow(int Id, string DisplayName, string Pass) {
            ...
            private void InitClass() {
                ...
                this.columnPass.MaxLength = 1000;
            }
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string DisplayName {
                get {
                    return ((string)(this[this.tableAccounts.DisplayNameColumn]));
                }
                set {
                    this[this.tableAccounts.DisplayNameColumn] = value;
                }
            }
...
namespace PhanMenBanMayTinh.QLMTDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Accounts] WHERE (([Id] = @Original_Id) AND ([DisplayName] = @O" +
                "riginal_DisplayName) AND ([Pass] = @Original_Pass))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Accounts] ([Id], [DisplayName], [Pass]) VALUES (@Id, @DisplayN" +
                "ame, @Pass);\r\nSELECT Id, DisplayName, Pass FROM Accounts WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Accounts] SET [Id] = @Id, [DisplayName] = @DisplayName, [Pass] = @P" +
                "ass WHERE (([Id] = @Original_Id) AND ([DisplayName] = @Original_DisplayName) AND" +
                " ([Pass] = @Original_Pass));\r\nSELECT Id, DisplayName, Pass FROM Accounts WHERE (" +
                "Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PhanMenBanMayTinh.Properties.Settings.Default.QLMTConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, DisplayName, Pass FROM dbo.Accounts";
        ...
        public virtual int Fill(QLMTDataSet.AccountsDataTable dataTable) {
        ...
        public virtual QLMTDataSet.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLMTDataSet.AccountsDataTable dataTable = new QLMTDataSet.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLMTDataSet.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_DisplayName, string Original_Pass) {
        ...
        public virtual int Insert(int Id, string DisplayName, string Pass) {
        ...
        public virtual int Update(int Id, string DisplayName, string Pass, int Original_Id, string Original_DisplayName, string Original_Pass) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string DisplayName, string Pass, int Original_Id, string Original_DisplayName, string Original_Pass) {
            return this.Update(Original_Id, DisplayName, Pass, Original_Id, Original_DisplayName, Original_Pass);
        }
    }
